...
/**
 * This is the Chess specialization of the Graphplan algorithm
 * Oluf Jensen 8.3.23
 ...
 * @author samagra
 */
public class ChessGraphPlanAlgorithm {

	private int theLevel = 0;
	private ChessLevel theChesslevel; // Contains the last level
    /**
     * function GRAPHPLAN(problem) returns solution or failure
     *
     ...
     */
    public List<List<ActionSchema>> graphPlan(ChessProblem problem) {
        //graph ← INITIAL-PLANNING-GRAPH(problem)
	...
	public ChessLevel getTheChesslevel() {
		return theChesslevel;
	}

	public void setTheChesslevel(ChessLevel theChesslevel) {
     ...
     */
    private List<List<ActionSchema>> extractSolution(ChessGraph graph, List<Literal> goals, int numLevel,
     ...
     */
    private boolean checkAllGoalsNonMutex(ChessLevel level, List<Literal> goals) {
     ...
     */
    private ChessGraph expandGraph(ChessGraph graph) {
     ...
     */
    private boolean levelledOff(ChessGraph graph) {
     ...
     */
    private ChessGraph initialPlanningGraph(ChessProblem problem) {
