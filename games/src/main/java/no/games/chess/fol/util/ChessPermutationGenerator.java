package no.games.chess.fol.util;
...
/**
 * This is the chess version of the PermutationGenerator
 * @author oluf 
 * @author samagra
 */
public class ChessPermutationGenerator {

    /**generatePermutations
     * This method generates all possible permutations over the given number of Constants in the list of objects
     * 
     * @param list
     * @param r
     * @return
